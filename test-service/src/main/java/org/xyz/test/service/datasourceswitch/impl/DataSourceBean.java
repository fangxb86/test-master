...
final class DataSourceBean {
    ...
    public DataSourceBean(DataSourceBeanBuilder beanBuilder){
        ...
        this.jndiName=beanBuilder.getJndiName();
    }
	...
	public String toString() {
		return "DataSourceBean [beanName=" + beanName + ", driverClassName=" + driverClassName + ", url=" + url
				+ ", username=" + username + ", password=" + password + ", validationQuery=" + validationQuery
				+ ", testOnBorrow=" + testOnBorrow + ", jndiName=" + jndiName + "]";
	}
