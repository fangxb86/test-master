...
public class DataSourceBeanBuilder {
    ...
    public DataSourceBeanBuilder(String beanName,String databaseIP,String databasePort,String databaseName,String username,String password,String jndiName){
	...
	public String toString() {
		return "DataSourceBeanBuilder [driverClassName=" + driverClassName + ", beanName=" + beanName + ", databaseIP="
				+ databaseIP + ", databasePort=" + databasePort + ", databaseName=" + databaseName + ", username="
				+ username + ", password=" + password + ", validationQuery=" + validationQuery + ", testOnBorrow="
				+ testOnBorrow + ", jndiName=" + jndiName + "]";
	}
