...
//        BeanDefinitionBuilder beanDefinitionBuilder = BeanDefinitionBuilder.genericBeanDefinition(BasicDataSource.class);//jdbc
        BeanDefinitionBuilder beanDefinitionBuilder = BeanDefinitionBuilder.genericBeanDefinition(JndiObjectFactoryBean.class);//jndi
    ...
    private <T> Map<String, Object> getPropertyKeyValues(Class<T> clazz, Object object) throws IllegalAccessException {
        ...
        //jdbc
//        result.remove("jndiName");
        //jndi
        result.remove("driverClassName");
        result.remove("url");
        result.remove("username");
        result.remove("password");
        result.remove("validationQuery");
        result.remove("testOnBorrow");
        return result;
    }
